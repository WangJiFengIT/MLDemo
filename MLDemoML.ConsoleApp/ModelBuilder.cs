...
namespace MLDemoML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\wangjifeng\Desktop\data.tsv";
        private static string MODEL_FILEPATH = @"../../../../MLDemoML.Model/MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.BinaryClassification.Trainers.LinearSvm(labelColumnName: "Sentiment", featureColumnName: "Features");
